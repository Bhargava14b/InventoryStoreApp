...
namespace InventoryStore.DL
{
    ...
    public partial class InventoryStoreEntityConnection : DbContext
    {
        ...
        public virtual int SP_GetOrders(Nullable<int> orderId, Nullable<int> userId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_GetOrders", orderIdParameter, userIdParameter);
        }
    
        public virtual dynamic SP_GetProducts(Nullable<int> productId)
        {
            var productIdParameter = productId.HasValue ?
                new ObjectParameter("ProductId", productId) :
                new ObjectParameter("ProductId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_GetProducts", productIdParameter);
        }
    }
}
